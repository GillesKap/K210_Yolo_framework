...
#
# from models import conv_blocks as ops
...
#         # NOTE 120*160*40 => 120*160*40 是k210 kpu ram的极限了
#         op(ops.expanded_conv, expansion_size=40, stride=2, num_outputs=24),
#         # NOTE 60*80*124 => 60*80*124 是k210 kpu ram的极限了
#         op(ops.expanded_conv, expansion_size=124,stride=1, num_outputs=24),
#         op(ops.expanded_conv, expansion_size=124,stride=2, num_outputs=32),
